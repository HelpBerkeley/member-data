...
public class HBCacheSerializable implements Cache, Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = LoggerFactory.getLogger(HBCacheSerializable.class);
    private int maxKeyDepth;
    private Map<JobDependency, LinkedList<CacheEntry>> cache;

    public HBCacheSerializable(int maxKeyDepth) {
